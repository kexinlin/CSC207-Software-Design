...
public abstract class DebtAccount extends Account {
	protected double limit;	// the maximum amount of debt you can incur.
	/**
	 ...
	 * @param limit the maximum amount of debt you can incur.
	 */
	DebtAccount(double balance, Date dateOfCreation, String accountId, User owner, double limit) {
